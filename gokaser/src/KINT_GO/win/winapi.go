...
//sys   SHGetFolderLocation(hOwner syscall.Handle, nFolder int, hToken syscall.Handle, dwReserved uint32, ppidl *uintptr) (hResult uint) = shell32.SHGetFolderLocation
//sys   SHGetPathFromIDList(pid uintptr, AppDataPath *uint16) (bResult bool) = shell32.SHGetPathFromIDList
//sys   SHGetSpecialFolderLocation(hOwner syscall.Handle, nFolder int, ppidl *uintptr) (hResult uint) = shell32.SHGetSpecialFolderLocation
//sys   SHGetKnownFolderIDList(rfid int, dwFlags uint32, hToken syscall.Handle, pidl uintptr) (hResult uint)
//sys   CreateMutex(lpSecurityAttributes uintptr,bInitalOwner bool, mutexName *uint16) (handle Handle, err error) [failretval==InvalidHandle] = CreateMutexW
//sys   EnumWindows(callback uintptr, lpparm uintptr) (success bool)
//sys   SetForegroundWindow(hwnd syscall.Handle) (success bool)
//sys   GetClassName(hwnd syscall.Handle, classname *uint16, bufflen uint ) (iResult uint)
