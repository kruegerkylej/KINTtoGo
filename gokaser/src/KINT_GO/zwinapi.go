...
func CreateMutex(lpMutexAttributes unintptr, bInitalOwner bool, lpName *uint16) (handle syscall.Handle, err error) {
	xxx = procCreateMutexW(lpMutexArrtibutes, bInitialOwner, lpName)
}
